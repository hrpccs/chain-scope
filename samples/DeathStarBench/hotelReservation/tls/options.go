...
func init() {
	...
	if needTLS {
		b, err := ioutil.ReadFile("/workspace/x509/ca_cert.pem")
		if err != nil {
		...
		creds, err = credentials.NewServerTLSFromFile("/workspace/x509/server_cert.pem", "/workspace/x509/server_key.pem")
		if err != nil {
